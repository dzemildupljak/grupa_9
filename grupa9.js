...
for (let i = 0; i < matrica.length; i++) {
  ...
  for (let j = 0; j < matrica[i].length - 3; j++) {
    proizvod =
      matrica[i][j] * matrica[i][j + 1] * matrica[i][j + 2] * matrica[i][j + 3];
    maxProzvod = Math.max(proizvod, maxProzvod);
  }
}

for (let i = 0; i < matrica.length - 3; i++) {
  for (let j = 0; j < matrica[i].length; j++) {
    proizvod =
      matrica[i][j] * matrica[i + 1][j] * matrica[i + 2][j] * matrica[i + 3][j];
    maxProzvod = Math.max(maxProzvod, proizvod);
  }
}
...
for (let i = 0; i < matrica.length - 3; i++) {
  for (let j = 3; j < matrica[i].length; j++) {
    proizvod =
      matrica[i][j] * // 0 3
      matrica[i + 1][j - 1] * // 1 2
      matrica[i + 2][j - 2] * // 2 1
